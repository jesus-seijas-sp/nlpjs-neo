...
class StemmerIt extends SnowballStemmer {
  ...
  r_prelude() {
    ...
    replab0: for (;;) {
      ...
      lab1: {
        ...
        const among_var = this.find_among(StemmerIt.a_0, 7);
        if (among_var === 0) {
          break lab1;
        }
  ...
  r_postlude() {
    ...
    replab0: for (;;) {
      ...
      lab1: {
        this.bra = this.cursor;
        const among_var = this.find_among(StemmerIt.a_1, 3);
        if (among_var === 0) {
          break lab1;
        }
        this.ket = this.cursor;
  ...
  r_attached_pronoun() {
    ...
    this.bra = this.cursor;
    const among_var = this.find_among_b(StemmerIt.a_3, 5);
    if (among_var === 0) {
      return false;
    }
    if (!this.r_RV()) {
  ...
  r_standard_suffix() {
    ...
    let v_4;
    this.ket = this.cursor;
    let among_var = this.find_among_b(StemmerIt.a_6, 51);
    if (among_var === 0) {
      return false;
    }
    this.bra = this.cursor;
  ...
  r_verb_suffix() {
    ...
    this.cursor = this.limit - v_1;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerIt.a_7, 87);
    if (among_var === 0) {
