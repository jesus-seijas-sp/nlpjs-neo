...
class StemmerRo extends SnowballStemmer {
  ...
  r_postlude(): boolean {
    ...
    replab0: for (;;) {
      ...
      lab1: {
        this.bra = this.cursor;
        const among_var = this.find_among(StemmerRo.a_0, 3);
        if (among_var === 0) {
          break lab1;
        }
        this.ket = this.cursor;
  ...
  r_combo_suffix(): boolean {
    ...
    const v_1 = this.limit - this.cursor;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerRo.a_2, 46);
    if (among_var === 0) {
      return false;
    }
    this.bra = this.cursor;
  ...
  r_standard_suffix(): boolean {
    ...
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerRo.a_3, 62);
    if (among_var === 0) {
      return false;
    }
    this.bra = this.cursor;
  ...
  r_verb_suffix(): boolean {
    ...
    this.cursor = this.limit - v_1;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerRo.a_4, 94);
    if (among_var === 0) {
