...
class StemmerFi extends SnowballStemmer {
  ...
  r_particle_etc(): boolean {
    ...
    const among_var = this.find_among_b(StemmerFi.a_0);
    if (among_var === 0) {
  ...
  r_possessive(): boolean {
    ...
    this.cursor = this.limit - v_1;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerFi.a_4);
    if (among_var === 0) {
      this.limit_backward = v_2;
      return false;
    }
    ...
    switch (among_var) {
      ...
      case 3:
        ...
        break;
      case 4:
        if (this.find_among_b(StemmerFi.a_1) === 0) {
          return false;
        }
        if (!this.slice_del()) {
          return false;
  ...
  r_case_ending(): boolean {
    ...
    this.cursor = this.limit - v_1;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerFi.a_6);
    if (among_var === 0) {
      this.limit_backward = v_2;
      return false;
    }
  ...
  r_other_endings(): boolean {
    ...
    this.cursor = this.limit - v_1;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerFi.a_7);
    if (among_var === 0) {
      this.limit_backward = v_2;
      return false;
    }
  ...
  r_i_plural(): boolean {
    ...
    this.cursor = this.limit - v_1;
    this.ket = this.cursor;
    if (this.find_among_b(StemmerFi.a_8) === 0) {
      this.limit_backward = v_2;
      return false;
    }
    this.bra = this.cursor;
  ...
  r_t_plural(): boolean {
    ...
    this.cursor = this.limit - v_4;
    this.ket = this.cursor;
    const among_var = this.find_among_b(StemmerFi.a_9);
    if (among_var === 0) {
